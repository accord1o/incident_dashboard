...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Владимир\PycharmProjects\incident_dashboard'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Владимир\PycharmProjects\incident_dashboard\Scripts\deactivate.nu'
